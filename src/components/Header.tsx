...
const SubscribeModal = dynamic(() => import('@/components/SubscribeModal/SubscribeModal'), { ssr: false })
          ...
          <div className="flex h-14 md:h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <motion.button
                ...
                className="hidden sm:flex items-center gap-1.5 md:gap-2 px-3 py-2 md:px-4 md:py-2 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white rounded-lg md:rounded-xl text-sm font-medium shadow-lg cursor-pointer"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
